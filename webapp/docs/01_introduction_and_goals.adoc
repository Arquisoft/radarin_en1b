...
The system is compatible with <a href="https://solidproject.org/">Solid Project</a>, and it securely stores data in decentralized data stores called Pods. Moreover, the system will ask for permission to access the information of the corresponding user's pods.
