...
function AdministerUsers() {
    ...
    return (
            <div className='main'>
                ...
                <p>User list:</p>
                {normalUsers === null? 
                    loadingScreen("margin-top-friends","We are searching for the Radarin users...") :normalUsers.size !== 0 ? listUsers(normalUsers, render, setRender) : <p>There are no users</p>
                }
            </div>);
}
