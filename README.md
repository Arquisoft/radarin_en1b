...
Links to the deployed sample application: [radarin desktop](https://radarinen1bwebapp.herokuapp.com) - [radarin mobile](https://radarinen1bmobile.herokuapp.com/). Note that sometimes **it can take a while to load** because Heroku in the free plan, takes the containers to sleep when they are not used for some time and taking them up takes time.
